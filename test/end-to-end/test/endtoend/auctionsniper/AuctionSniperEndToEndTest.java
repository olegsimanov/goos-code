...
public class AuctionSniperEndToEndTest {
    ...
    sniperJoinsAuctionUntilAuctionCloses() throws Exception {
        ...
        application.showsSniperHasLostAuction(auction.getItemId(), 0, 0);
    }
    ...
    sniperMakesAHigherBidButLoses() throws Exception {
        ...
        auction.announceClosed();
        application.showsSniperHasLostAuction(auction.getItemId(), 1000, 1098);
    }
    ...
    sniperLosesAnAuctionWhenThePriceIsTooHigh() throws Exception {
        ...
        auction.announceClosed();
        application.showsSniperHasLostAuction(auction.getItemId(), 1207, 1098);
